...
const Register = () => {
    ...
    return (
        < div className="flex justify-center items-center h-screen font-inter" >
            <div className="login-form form-container rounded-xl shadow drop-shadow-lg p-12 bg-p-white mw-[500px] mh-[650px] ">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-row gap-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="text" name="username" id="username" value={payload.username} onChange={(e) => setPayload({ ...payload, username: e.target.value })} required className="border border-[#a1a1a1] rounded h-9 p-3" placeholder="johndoe" />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row gap-4">
                        <div className="flex flex-col">
                            ...
                            <input type="password" name="password" id="password" value={payload.password} onChange={(e) => setPayload({ ...payload, password: e.target.value })} required className="border border-[#a1a1a1] rounded h-9 p-3" />
                        </div>
                        <div className="flex flex-col">
                    ...
                    <div className="flex justify-center">
                        <button className="h-9 w-full rounded-md text-p-white bg-p-pink font-semibold shadow mt-5" onClick={handleRegister}>Register</button>
